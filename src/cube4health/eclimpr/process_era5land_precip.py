...
def process_era5land_precip_epiweek(main_dir, folder_name, shapefile_path, variable_name, years_epi_week, indicator_name, color_png_file, aggregation_type = "all", interval_file_path=None, provide_interval=False):
    """
    ...
    list_climate_format_files(file_paths = main_dir, output_dir = indicator_dir, variable_input = variable_name, indicator_name_local = indic_name, years_work = years_epi_week, extension_folder = "epiweek", type_indicator = "precip", source="era5land")
...
def process_era5land_precip_month(main_dir, folder_name, shapefile_path, variable_name, years_month, indicator_name, color_png_file, aggregation_type = "all"):
    """
    ...
    # Create a set of cog images from NetCDF files - generate_COG.py
    list_climate_format_files(file_paths = main_dir, output_dir = indicator_dir, variable_input = variable_name, indicator_name_local = indic_name, years_work = years_month, extension_folder = "month", type_indicator = "precip", source="era5land")
